...
Detailed per-platform parameter reference for `social_createSocialMediaPost`. All
platform settings go inside the `additional` object, grouped by platform name.
